...
@Service
    ...
    public List<Survey> retrieveALLSurveys () {
        ...
        public static Survey retrieveSurveyById (String surveyId) {
        ...
        public static List<Question> retrieveAllSurveyQuestions (String surveyId){
            Survey survey = retrieveSurveyById(surveyId);
            if(survey==null) return null;
            return survey.getQuestions();
        }
        public static Question retrieveSpecificSurveyQuestion (String surveyId, String questionId) {
    ...
    public static String  addNewSurveyQuestion(String surveyId, Question question) {
...
return question.getId();
    ...
    public  static String deleteSurveyQuestion (String surveyId, String questionId) {
        List<Question> surveyQuestions = retrieveAllSurveyQuestions(surveyId);
    ...
    public static void updateSurveyQuestion(String surveyId, String questionId, Question question) {
        List<Question>  questions = retrieveAllSurveyQuestions(surveyId);
